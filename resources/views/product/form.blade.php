        ...
        <div style="padding-top: 10px">
            <form action="{{ $route }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="input-group mb-3">
                    <img class="semimagem" src="{{ asset('images/' . $file_name) }}" width="150px" alt="image">
                    <div class="input-group mb-3">
                        <div class="custom-file">
                            <input class="block w-full text-sm text-slate-500
                                                            ...
                                                            hover:file:bg-green-100" type="file" name="image">
                            <input type="file" name="image" id="selecao-arquivo" class="inputImage">
