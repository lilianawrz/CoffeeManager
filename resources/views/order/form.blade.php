    ...
    <div class="col-md-10 p-4">
        ...
        <div style="padding-top: 10px">
            <form action="{{ $route }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    <div class="col-6">
                        <label for="moment" class="form-label">Data</label>
                        <input type="date" name="moment" id="moment" class="form-control"
                ...
                <div class="mb-3">
                    <label for="payment_id" class="form-label">Pagamento</label>
